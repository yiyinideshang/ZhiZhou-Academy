...
namespace Maticsoft.DAL
{
	public partial class Favorite
	{
		...
		public int GetMaxId()
		{
			return DbHelperSQL.GetMaxID("Id", "Favorites");
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,UserId,CourseId,AddTime from Favorites ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.Favorite model=new Maticsoft.Model.Favorite();
		...
		public Maticsoft.Model.Favorite DataRowToModel(DataRow row)
		{
			Maticsoft.Model.Favorite model=new Maticsoft.Model.Favorite();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Favorites T ");
